...
using LogisticsPlatform.ServiceDiscovery.Configuration;
using LogisticsPlatform.ServiceDiscovery.GrpcServices;

namespace LogisticsPlatform.ServiceDiscovery;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        services.Configure<DbState>(
            o =>
            {
                var state = _configuration.GetValue<string>("LOGISTICS_DB_STATE");
